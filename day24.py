...
for i in range(ny):
    ...
    if y_min_pattern <= yy <= y_max_pattern:
        ...
        if yy < 0:
            current_left_width = left_width_bottom
        else:
            current_left_width = left_width_top

        left_x1 = left_center - current_left_width / 2
        left_x2 = left_center + current_left_width / 2
